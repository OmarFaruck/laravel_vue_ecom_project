        ...
        <div class="card mt-4 px-4 py-4 container text-center justify-content-center">
            ...
            <Vue3EasyDataTable :headers="headers" :items="items" :rows-per-page="10" border-cell
                ...
                <template #item-image="item">
                    <img :src="`/storage/brands/${item.image}`" width="80" height="60" class="rounded" />
                </template>
                ...
                <div class="modal-content">
                    <form @submit.prevent="submitcreate">
                        <div class="modal-header">
                            <h5 class="modal-title">Brand Create Form</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label>Name:</label>
                                <input v-model="form.name" type="text" placeholder="Brand Create Name"
                                    class="form-control" />
                            ...
                            <div class="mb-3">
                                <label>Slug:</label>
                                <input v-model="form.slug" type="text" placeholder="Brand Create Slug"
                                    class="form-control" />
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form @submit.prevent="submitUpdate">
                        <div class="modal-header">
                            <h5 class="modal-title">Brand Edit Form</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                        </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label>Name:</label>
                                <input v-model="form.name" type="text" placeholder="Brand Edit Name"
                                    class="form-control" />
                                <div class="text-danger" v-if="form.errors.name">
                                    {{ form.errors.name }}
                                </div>
                            ...
                            <div class="mb-3">
                                <label>Slug:</label>
                                <input v-model="form.slug" type="text" placeholder="Brand Edit Slug"
                                    class="form-control" />
                                <div class="text-danger" v-if="form.errors.slug">
                                    {{ form.errors.slug }}
                                </div>
...
const searchField = ["id", "image", "name", "slug"];
const searchValue = ref();

const page = usePage();

const items = computed(() => page.props.brand || []);
const headers = [
    { text: "ID", value: "id" },
...
const submitcreate = () => {
    ...
    swal("Good job!", "This Brand will be added", "success");
};
...
function submitUpdate() {
    ...
    swal("Good job!", "This Brand will be updated", "success");
}
