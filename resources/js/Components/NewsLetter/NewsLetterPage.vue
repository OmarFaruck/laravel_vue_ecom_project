        ...
        <div class="card mt-4 px-4 py-4 container text-center justify-content-center">
            ...
            <Vue3EasyDataTable :headers="headers" :items="items" :rows-per-page="10" border-cell
                ...
                <template #item-image="item">
                    <img :src="`/storage/newsletter/${item.image}`" width="80" height="60" class="rounded" />
                </template>
                ...
                <div class="modal-content">
                    <form @submit.prevent="submitcreate">
                        <div class="modal-header">
                            <h5 class="modal-title">NewsLetter Create Form</h5>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form @submit.prevent="submitUpdate">
                        <div class="modal-header">
                            <h5 class="modal-title">NewsLetter Edit Form</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                        </div>
...
const items = computed(() => page.props.NewsLetter || []);
const headers = [
    { text: "ID", value: "id" }, 
...
const submitcreate = () => {
    ...
    swal("Good job!", "This newsletter will be added", "success");
};
...
function submitUpdate() {
    ...
    swal("Good job!", "This newsletter will be updated", "success");
}
