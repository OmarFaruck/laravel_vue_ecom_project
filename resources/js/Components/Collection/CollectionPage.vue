        ...
        <div class="card mt-4 px-4 py-4 container text-center justify-content-center">
            ...
            <Vue3EasyDataTable :headers="headers" :items="items" :rows-per-page="10" border-cell
                ...
                <template #item-image="item">
                    <img :src="`/storage/collection/${item.image}`" width="80" height="60" class="rounded" />
                </template>
                ...
                <div class="modal-content">
                    <form @submit.prevent="submitcreate">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label>Heading:</label>
                                <input v-model="form.heading" type="text" placeholder="Brand Create Name"
                                    class="form-control" />
                            ...
                            <div class="mb-3">
                                <label>Title:</label>
                                <input v-model="form.title" type="text" placeholder="Brand Create Title"
                                    class="form-control" />
                ...
                <div class="modal-content">
                    <form @submit.prevent="submitUpdate">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label>Heading:</label>
                                <input v-model="form.heading" type="text" placeholder="Brand Edit Heading"
                                    class="form-control" />
                                <div class="text-danger" v-if="form.errors.heading">
                                    {{ form.errors.heading }}
                                </div>
                            ...
                            <div class="mb-3">
                                <label>Title:</label>
                                <input v-model="form.title" type="text" placeholder="Brand Edit Title"
                                    class="form-control" />
                                <div class="text-danger" v-if="form.errors.title">
                                    {{ form.errors.title }}
                                </div>
...
const searchField = ["id", "image", "heading", "title"];
const searchValue = ref();

const page = usePage();

const items = computed(() => page.props.collections || []);
const headers = [
    { text: "ID", value: "id" },
...
const submitcreate = () => {
    ...
    swal("Good job!", "This Collection will be added", "success");
};
